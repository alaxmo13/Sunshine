...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        assertTrue("Error: Nor Records returned from location query", cursor.moveToFirst());
    ...
    public long testWeatherTable() {
        ...
        long location = testLocationTable();
        ContentValues testValues = TestUtilities.createWeatherValues(location);
        ...
        // Move the cursor to a valid database row
        assertTrue("Error: Nor Records returned from weather query", cursor.moveToFirst());
